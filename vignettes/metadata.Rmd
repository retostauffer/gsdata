...
#| fig.alt: >
#|    Spatial plot showing the location of all stations
#|    available via this resource (synop-v1-1h).
...
```{r, fig = TRUE, fig.width = 8, fig.height = 4}
#| fig.alt: >
#|    Spatial plot showing the location of all stations (synop-v1-1h)
#|    where the symbols indicate whether or not the station is still
#|    active or not.
